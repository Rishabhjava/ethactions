...
export default function Morph() {
  const [formData, setFormData] = useState({
    tab1: { field1: 'Your Name', field2: 'Your Morph Wallet Address' },
    tab2: { field1: 'Sell Something!', field2: 'Your Morph Wallet Address' },
    tab3: { field1: 'https://i.pinimg.com/originals/8f/b1/73/8fb1736ec8511594d46dfd83d1533c7b.jpg', field2: 'Your Morph Wallet Address' },
  })
